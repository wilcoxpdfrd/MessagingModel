...
{
    internal class ZeroMQIpcReplyChannelListener :
        ZeroMQConnectionOrientedChannelListener<IReplyChannel, ReplyChannelAcceptor>, ISingletonChannelListener
    {
        ...
        public ZeroMQIpcReplyChannelListener(ZeroMQIpcConnectionOrientedTransportBindingElement bindingElement, BindingContext context) :

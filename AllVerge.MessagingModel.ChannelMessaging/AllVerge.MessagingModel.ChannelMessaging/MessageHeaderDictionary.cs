...
namespace AllVerge.MessagingModel.ChannelMessaging
{
    ...
    /// </summary>
    public class MessageHeaderDictionary : IHeaderDictionary
    {
        ...
        public MessageHeaderDictionary()
        {
        }

        public MessageHeaderDictionary(Dictionary<string, StringValues> store)
        {
            Store = store;
        }

        public MessageHeaderDictionary(int capacity)
        {
        ...
        /// <summary>
        /// Gets the number of elements contained in the <see cref="MessageHeaderDictionary" />;.
        /// </summary>
        /// <returns>The number of elements contained in the <see cref="MessageHeaderDictionary" />.</returns>
        public int Count => Store?.Count ?? 0;

        /// <summary>
        /// Gets a value that indicates whether the <see cref="MessageHeaderDictionary" /> is in read-only mode.
        /// </summary>
        /// <returns>true if the <see cref="MessageHeaderDictionary" /> is in read-only mode; otherwise, false.</returns>
        ...
        /// <summary>
        /// Determines whether the <see cref="MessageHeaderDictionary" /> contains a specific key.
        /// </summary>
        /// <param name="key">The key.</param>
        /// <returns>true if the <see cref="MessageHeaderDictionary" /> contains a specific key; otherwise, false.</returns>
        ...
        /// <summary>
        /// Copies the <see cref="MessageHeaderDictionary" /> elements to a one-dimensional Array instance at the specified index.
        /// </summary>
        /// <param name="array">The one-dimensional Array that is the destination of the specified objects copied from the <see cref="MessageHeaderDictionary" />.</param>
        ...
        /// <returns>true if the <see cref="MessageHeaderDictionary" /> contains the key; otherwise, false.</returns>
